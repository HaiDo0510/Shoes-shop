		...
		<div class="top-header-main">
			...
			<div class="col-md-4 top-header-right">
				<div class="cart box_1">
						...
						<p><a href="account.jsp" style="color: #702428;font-weight: 500;font-size: 13px;">Register or Login</a></p>
		...
		<div class="container">
			<div class="banner-bottom-top">
				<div class="col-md-6 banner-bottom-left">
					<div class="bnr-one">
						<div class="bnr-left">
							<h1><a href="single.jsp">Duis dictum volutpat</a></h1>
				...
				<div class="col-md-6 banner-bottom-right">
					<div class="bnr-two">
						<div class="bnr-left">
							<h2><a href="single.jsp">Phasellus quis nunc</a></h2>
							<p>Nulla tempus facilisis purus at.</p>
							<div class="b-btn"> 
								<a href="single.jsp">SHOP NOW</a>
							</div>
