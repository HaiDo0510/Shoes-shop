			...
			<div class="product-main">
				<div class="col-md-9 p-left">
					...
					<div style="clear:both; margin-left: 37%;">
						<ul class="pagination">
							<li class="page-item"><a class="page-link" href="products-user.jsp">Previous</a>
							</li>
							<li class="page-item active"><a class="page-link" href="products-user.jsp">1</a></li>
							<li class="page-item"><a class="page-link" href="products1-user.jsp">2</a></li>
							<li class="page-item"><a class="page-link" href="products2-user.jsp">3</a></li>
							<li class="page-item"><a class="page-link" href="products1-user.jsp"> <span
