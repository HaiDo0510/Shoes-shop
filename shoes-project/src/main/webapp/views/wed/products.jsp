			...
			<div class="top-header-main">
				...
				<div class="col-md-4 top-header-right">
					...
					<div class="cart box_1">
						...
						<p>
							<a href="account.jsp"
								style="color: #702428; font-weight: 500; font-size: 13px;">Register
								or Login</a>
						</p>
		...
		<div class="container">
			<div class="top-nav">
				<ul class="memenu skyblue">
					...
					<li class="grid"><a href="products.jsp">Men</a>
						<div class="mepanel">
							<div class="row">
					...
					<li class="grid"><a href="products.jsp">Women</a>
						<div class="mepanel">
							<div class="row">
								<div class="col1 me-one">
									<h4>Shop</h4>
					...
					<li class="grid"><a href="products.jsp">Kids</a>
						<div class="mepanel">
							<div class="row">
								<div class="col1 me-one">
									<h4>Shop</h4>
					...
					<li class="grid"><a href="products.jsp">Sports</a>
						<div class="mepanel">
							<div class="row">
								<div class="col1 me-one">
									<h4>Shop</h4>
					...
					<li class="grid"><a href="products.jsp">Brands</a>
						<div class="mepanel">
							<div class="row">
								<div class="col1 me-one">
			...
			<div class="product-main">
				<div class="col-md-9 p-left">
					<div class="product-one">
						...
						List<Product> products = dao.getPart1();
						...
						<div class="col-md-4 product-left single-left">
							<div class="p-one simpleCart_shelfItem">
								...
								<h4><%=p.getName()%></h4>
								<p>
									<a class="item_add" href="account.jsp"><i></i> <span
					...
					<div style="clear:both; margin-left: 37%;">
						<ul class="pagination">
							<li class="page-item"><a class="page-link" href="products.jsp">Previous</a>
							</li>
							<li class="page-item active"><a class="page-link" href="products.jsp">1</a></li>
							<li class="page-item"><a class="page-link" href="products1.jsp">2</a></li>
							<li class="page-item"><a class="page-link" href="products2.jsp">3</a></li>
							<li class="page-item"><a class="page-link" href="products1.jsp"> <span
