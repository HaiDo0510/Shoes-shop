				...
				<div class="col-md-4 top-header-right">
					<div class="dropdown" style="float: left">
						...
						<div class="dropdown-child">
							<a href="#">Xem Thông tin cá nhân</a> <a href="checkout.jsp">Xem giỏ
								hàng</a> <a href="history.jsp">Xem
		...
		<div class="container">
			<div class="ckeckout-top">
				<div class=" cart-items heading">
					<h3 style="margin-bottom:50px;">My Shopping Bag</h3>
					<% 
					Cart cart=(Cart)session.getAttribute("cart");
				     ...
				     ArrayList<ProductID> a = (ArrayList<ProductID>) cart.getGH();
					%>

					<form action="../../Order?totalPrice=<%= cart.Tongtien()%>&email=<%=email %>" method="post">
						
						<input type="submit"
							value="In Hóa đơn" name="in" />
						<hr />
						...
						<table border="1" width="70%" style="text-align: center;">
							...
							<tr>
								<td><%=i.getId() %></td>
								<td><img src="./images/<%= i.getImage() %>" style="height: 40px; width:40px;" /></td>
								<td><%=i.getName() %></td>
								<td><%=i.getQuantity() %></td>
								<td><%=i.getSum() %> $</td>
							</tr>
