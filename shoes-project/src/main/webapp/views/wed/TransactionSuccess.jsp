					...
					<div class="dropdown" style="float: left">
						...
						<div class="dropdown-child">
							<a href="#">Xem Thông tin cá nhân</a> <a href="checkout.jsp">Xem giỏ
								hàng</a> <a href="history.jsp">Xem Lịch sử giao dịch</a> <a href="index.jsp">Đăng xuất</a>
						</div>
					</div>
		...
		<div class="container">
			<div class="ckeckout-top">
				<div class=" cart-items heading">
					<h1 style="align-text: center;">Giao Dịch Thành Công !!</h1>
					<a href="checkout.jsp"><button >Quay Lại</button></a>
				</div>
			</div>
		</div>
	</div>
