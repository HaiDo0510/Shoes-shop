			...
			<div class="product-main">
				<div class="col-md-9 p-left">
					<div class="product-one">
						...
						List<Product> products = dao.getPart2();
					...
					<div style="clear:both; margin-left: 37%;">
						<ul class="pagination">
							...
							<li class="page-item"><a class="page-link" href="products.jsp">1</a></li>
							<li class="page-item active"><a class="page-link" href="products1.jsp">2</a></li>
							<li class="page-item"><a class="page-link" href="products2.jsp">3</a></li>
							<li class="page-item"><a class="page-link" href="products2.jsp"> <span
